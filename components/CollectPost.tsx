...
const CollectPost = ({postId,style, showText=false}: {postId: string,style:string,showText?: boolean}) => {
  ...
  return (
    <>
        <button className={`bg-base-200 flex justify-center items-center  hover:bg-primary hover:text-primary-800 ${style}`}
        onClick={onOpen}
        >
            <Bookmark className=''/>
            {
